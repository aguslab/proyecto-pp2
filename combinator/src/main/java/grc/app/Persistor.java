...
//		tallerUtilitarios.setId(31);
		ingles1 = new Materia("Ingles Lectocomprension I", "Ingles 1");
//		ingles1.setId(32);
		ingles2 = new Materia("Ingles Lectocomprension II", "Ingles 2");
//		ingles2.setId(33);
		ingles3 = new Materia("Ingles Lectocomprension III", "Ingles 3");
//		ingles3.setId(34);
