...
public class CopyOfRecomendacion 
{
	...
	public CopyOfRecomendacion ()
	{
		
	}

	public CopyOfRecomendacion(String[] l, String[] m, String[] mi, String[] j, String[] v, String[] s)
	{
		this.lunes = l;
		this.martes = m;
		this.miercoles = mi;
	...
	public void mostrarRecomendacion(CopyOfRecomendacion recomendacion)
	{
		//Lunes
